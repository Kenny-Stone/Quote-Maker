...
class VideoEditor:
    def __init__(self,filename,brightness_level : float = 1,_target_resolution = (1080,1920)):
    ...
    def addImage(self,_img_location,_position = "center",_size = (20,20),_is_mask: bool = False,_is_transparent : bool = True):
        '''
        Docstring for addImage
        
        :param _img_location: The location of the image to be added.
        :type _img_location: str
        :param _position: position of the image it can be a `tuple` or a `str`. eg `center`,`left`,`(50,50)`
